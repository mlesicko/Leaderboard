...
var len__28364__auto___39915 = arguments.length;
var i__28365__auto___39916 = (0);
while(true){
if((i__28365__auto___39916 < len__28364__auto___39915)){
args__28371__auto__.push((arguments[i__28365__auto___39916]));

var G__39917 = (i__28365__auto___39916 + (1));
i__28365__auto___39916 = G__39917;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__28372__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq39913){
var G__39914 = cljs.core.first.call(null,seq39913);
var seq39913__$1 = cljs.core.next.call(null,seq39913);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__39914,seq39913__$1);
});
...
return (p1__39918_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1507441610918
