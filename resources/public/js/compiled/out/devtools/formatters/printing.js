...
var len__28364__auto___39924 = arguments.length;
var i__28365__auto___39925 = (0);
while(true){
if((i__28365__auto___39925 < len__28364__auto___39924)){
args__28371__auto__.push((arguments[i__28365__auto___39925]));

var G__39926 = (i__28365__auto___39925 + (1));
i__28365__auto___39925 = G__39926;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__28372__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq39921){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__39922,G__39923,seq39921__$2);
});
...
if(cljs.core.truth_((function (){var or__27195__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__27820__auto__,writer__27821__auto__,opt__27822__auto__){
return cljs.core._write.call(null,writer__27821__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__27183__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__27183__auto__){
var or__27195__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__27195__auto__)){
return or__27195__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__39927_SHARP_){
return !((cljs.core.meta.call(null,p1__39927_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__39928__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__27195__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e39932){var _e__39658__auto__ = e39932;
return false;
}})();
if(cljs.core.truth_(or__27195__auto__)){
return or__27195__auto__;
...
}catch (e39934){var _e__39658__auto__ = e39934;
return false;
}}
})())){
...
var _STAR_current_state_STAR_39936 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__39937 = opts;
...
var markup_db = cljs.core.get.call(null,map__39937__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_39936;
}});
...
;
var temp__4655__auto___39941 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___39941)){
var managed_print_level_39942 = temp__4655__auto___39941;
var _STAR_print_level_STAR_39940_39943 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_39942;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_39940_39943,managed_print_level_39942,temp__4655__auto___39941,writer,opts,job_fn){
return (function (p1__39939_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__39939_SHARP_,null);
});})(_STAR_print_level_STAR_39940_39943,managed_print_level_39942,temp__4655__auto___39941,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_39940_39943;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1507441611270
