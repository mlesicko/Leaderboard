...
var G__39895 = devtools.prefs.pref.call(null,v);
v = G__39895;
continue;
} else {
return v;
...
var and__27183__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__27183__auto__){
var and__27183__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__27195__auto__ = (function (){try{if(!((value == null))){
...
}catch (e39898){var _e__39658__auto__ = e39898;
return false;
}})();
if(cljs.core.truth_(or__27195__auto__)){
return or__27195__auto__;
} else {
var or__27195__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e39902){var _e__39658__auto__ = e39902;
return false;
}})();
...
}catch (e39904){var _e__39658__auto__ = e39904;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__27183__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__27183__auto__)){
var and__27183__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__27183__auto____$1){
...
var and__27183__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__27183__auto__)){
...
var or__27195__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__27195__auto__)){
return or__27195__auto__;
} else {
...
var and__27183__auto__ = (function (){var or__27195__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__27195__auto__)){
return or__27195__auto__;
} else {
...
var vec__39906 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__39906,(0),null);
var name = cljs.core.nth.call(null,vec__39906,(1),null);
...
var and__27183__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__27183__auto__)){
...
var or__27195__auto__ = typeof value === 'string';
if(or__27195__auto__){
return or__27195__auto__;
} else {
var or__27195__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__39909_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__39909_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1507441610793
