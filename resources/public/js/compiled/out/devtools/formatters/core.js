...
var and__27183__auto__ = cljs.core.not.call(null,devtools.formatters.state.prevent_recursion_QMARK_.call(null));
if(and__27183__auto__){
var or__27195__auto__ = devtools.formatters.helpers.cljs_value_QMARK_.call(null,value);
...
}catch (e41413){var _e__39658__auto__ = e41413;
return false;
...
}catch (e41415){var _e__39658__auto__ = e41415;
return false;
...
}catch (e41417){var _e__39658__auto__ = e41417;
return false;
...
}catch (e41419){var _e__39658__auto__ = e41419;
return false;
...
}catch (e41421){var _e__39658__auto__ = e41421;
return false;
}})())){
...
}catch (e41423){var _e__39658__auto__ = e41423;
return false;
}})())){
...
var _STAR_current_state_STAR_41425 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = (function (){var or__27195__auto__ = config;
if(cljs.core.truth_(or__27195__auto__)){
return or__27195__auto__;
} else {
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_41425;
}});
});
...
return (function() { 
var G__41427__delegate = function (args){
...
var G__41428__i = 0, G__41428__a = new Array(arguments.length -  0);
while (G__41428__i < G__41428__a.length) {G__41428__a[G__41428__i] = arguments[G__41428__i + 0]; ++G__41428__i;}
  args = new cljs.core.IndexedSeq(G__41428__a,0,null);
} 
return G__41427__delegate.call(this,args);};
G__41427.cljs$lang$maxFixedArity = 0;
G__41427.cljs$lang$applyTo = (function (arglist__41429){
var args = cljs.core.seq(arglist__41429);
return G__41427__delegate(args);
});
...
var pre_handler = (function (){var or__27195__auto__ = devtools.prefs.pref.call(null,pre_handler_key);
if(cljs.core.truth_(or__27195__auto__)){
return or__27195__auto__;
} else {
...
var post_handler = (function (){var or__27195__auto__ = devtools.prefs.pref.call(null,post_handler_key);
if(cljs.core.truth_(or__27195__auto__)){
return or__27195__auto__;
} else {
return cljs.core.identity;
...
//# sourceMappingURL=core.js.map?rel=1507441622812
