...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__27820__auto__,writer__27821__auto__,opt__27822__auto__){
return cljs.core._write.call(null,writer__27821__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__39499 = o;
(G__39499[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__39500__delegate = function (args){
...
return G__39500__delegate.call(this,args);};
G__39500.cljs$lang$maxFixedArity = 0;
G__39500.cljs$lang$applyTo = (function (arglist__39502){
var args = cljs.core.seq(arglist__39502);
return G__39500__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__27183__auto__ = !((jsprops == null));
if(and__27183__auto__){
var and__27183__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__39505 = jsprops;
(G__39505["defaultValue"] = value);

(G__39505["onChange"] = ((function (G__39505,v,value,on_change){
return (function (p1__39504_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__39504_SHARP_);
});})(G__39505,v,value,on_change))
);
...
var vec__39508 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__39508,(0),null);
var id = cljs.core.nth.call(null,vec__39508,(1),null);
var class$ = cljs.core.nth.call(null,vec__39508,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___39512 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___39512 == null)){
} else {
var key_39513 = temp__4661__auto___39512;
(jsprops["key"] = key_39513);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__39514 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__39514["name"] = c);
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__28372__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq39517){
var G__39518 = cljs.core.first.call(null,seq39517);
var seq39517__$1 = cljs.core.next.call(null,seq39517);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__39518,seq39517__$1);
});
...
break;
default:
var G__39524 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__39524;
continue;
...
var n__28140__auto___39526 = a.length;
var i_39527 = (0);
while(true){
if((i_39527 < n__28140__auto___39526)){
(a[i_39527] = reagent.impl.template.as_element.call(null,(a[i_39527])));

var G__39528 = (i_39527 + (1));
i_39527 = G__39528;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__28140__auto___39529 = a.length;
var i_39530 = (0);
while(true){
if((i_39530 < n__28140__auto___39529)){
var val_39531 = (a[i_39530]);
if((cljs.core.vector_QMARK_.call(null,val_39531)) && ((reagent.impl.template.key_from_vec.call(null,val_39531) == null))){
(o["no-key"] = true);
} else {
}

(a[i_39530] = reagent.impl.template.as_element.call(null,val_39531));

var G__39532 = (i_39530 + (1));
i_39530 = G__39532;
continue;
} else {
}
...
var ctx = ({});
var vec__39533 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__39533,(0),null);
var derefed = cljs.core.nth.call(null,vec__39533,(1),null);
...
var G__39536 = (cljs.core.count.call(null,argv) - first_child);
switch (G__39536) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__39536){
...
//# sourceMappingURL=template.js.map?rel=1507441608067
