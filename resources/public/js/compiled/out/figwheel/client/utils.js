...
var or__27195__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj36240 = {"detail":data};
return obj36240;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__27183__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__27183__auto__)){
var and__27183__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__36247 = cljs.core._EQ_;
var expr__36248 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__36247.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__36248))){
return ((function (pred__36247,expr__36248){
return (function (p1__36241_SHARP_){
return console.warn(p1__36241_SHARP_);
});
;})(pred__36247,expr__36248))
} else {
if(cljs.core.truth_(pred__36247.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__36248))){
return ((function (pred__36247,expr__36248){
return (function (p1__36242_SHARP_){
return console.debug(p1__36242_SHARP_);
});
;})(pred__36247,expr__36248))
} else {
if(cljs.core.truth_(pred__36247.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__36248))){
return ((function (pred__36247,expr__36248){
return (function (p1__36243_SHARP_){
return console.error(p1__36243_SHARP_);
});
;})(pred__36247,expr__36248))
} else {
return ((function (pred__36247,expr__36248){
return (function (p1__36244_SHARP_){
return console.log(p1__36244_SHARP_);
});
;})(pred__36247,expr__36248))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__36251){
...
var eval_fn = cljs.core.get.call(null,map__36252__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__36254_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__36256,(0),null);
var v = cljs.core.nth.call(null,vec__36256,(1),null);
...
if(cljs.core.truth_((function (){var and__27183__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1507441589252
