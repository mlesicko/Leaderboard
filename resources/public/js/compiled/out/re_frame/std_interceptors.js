...
var vec__45206_45209 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_45210 = cljs.core.nth.call(null,vec__45206_45209,(0),null);
var only_after_45211 = cljs.core.nth.call(null,vec__45206_45209,(1),null);
var db_changed_QMARK__45212 = (!((only_before_45210 == null))) || (!((only_after_45211 == null)));
if(db_changed_QMARK__45212){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_45210);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_45211);
...
var map__45213 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var event = cljs.core.get.call(null,map__45213__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__45215 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__45215__$1 = ((((!((map__45215 == null)))?((((map__45215.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__45215.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__45215):map__45215);
var coeffects = map__45215__$1;
var event = cljs.core.get.call(null,map__45215__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__28364__auto___45218 = arguments.length;
var i__28365__auto___45219 = (0);
while(true){
if((i__28365__auto___45219 < len__28364__auto___45218)){
args__28371__auto__.push((arguments[i__28365__auto___45219]));

var G__45220 = (i__28365__auto___45219 + (1));
i__28365__auto___45219 = G__45220;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__28372__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq45217){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq45217));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__27195__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__28371__auto__ = [];
var len__28364__auto___45226 = arguments.length;
var i__28365__auto___45227 = (0);
while(true){
if((i__28365__auto___45227 < len__28364__auto___45226)){
args__28371__auto__.push((arguments[i__28365__auto___45227]));

var G__45228 = (i__28365__auto___45227 + (1));
i__28365__auto___45227 = G__45228;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__28372__auto__);
});
...
return (function (p1__45221_SHARP_){
return cljs.core.get_in.call(null,new_db,p1__45221_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__45222_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__45222_SHARP_);
});})(new_db,old_db,new_ins))
,in_paths);
var changed_ins_QMARK_ = (function (){var and__27183__auto__ = cljs.core.contains_QMARK_.call(null,re_frame.interceptor.get_effect.call(null,context),new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq45223){
var G__45224 = cljs.core.first.call(null,seq45223);
var seq45223__$1 = cljs.core.next.call(null,seq45223);
var G__45225 = cljs.core.first.call(null,seq45223__$1);
var seq45223__$2 = cljs.core.next.call(null,seq45223__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__45224,G__45225,seq45223__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1507441651317
